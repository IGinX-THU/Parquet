 ...
 * under the License.
 */
package org.apache.parquet.local.filter2.compat;
...
import org.apache.parquet.local.filter2.bloomfilterlevel.BloomFilterImpl;
...
/**
 * Given a {@link Filter} applies it to a list of BlockMetaData (row groups) If the Filter is an
 * {@link org.apache.parquet.filter.UnboundRecordFilter} or the no op filter, no filtering will be
 * performed.
 */
