...
package org.apache.parquet.local.filter2.bloomfilterlevel;
...
import org.apache.parquet.local.BloomFilterReader;
...
public class BloomFilterImpl implements FilterPredicate.Visitor<Boolean> {
  ...
  private final Map<ColumnPath, ColumnChunkMetaData> columns =
      new HashMap<ColumnPath, ColumnChunkMetaData>();
  ...
  private BloomFilterImpl(
      List<ColumnChunkMetaData> columnsList, BloomFilterReader bloomFilterReader) {
  ...
  private final BloomFilterReader bloomFilterReader;
