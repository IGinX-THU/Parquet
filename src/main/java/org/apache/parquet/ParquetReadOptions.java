...
public class ParquetReadOptions {
  ...
  private final boolean usePreviousFilter;
  private final Function<MessageType, MessageType> schemaConvertor;
  ...
  ParquetReadOptions(
      ...
      boolean usePreviousFilter,
      Function<MessageType, MessageType> schemaConvertor,
    ...
    this.usePreviousFilter = usePreviousFilter;
  ...
  public boolean usePreviousFilter() {
    return usePreviousFilter;
  }

  public Function<MessageType, MessageType> getSchemaConvertor() {
  ...
  public static class Builder {
    ...
    protected CompressionCodecFactory codecFactory = new CodecFactory();
    ...
    private boolean usePreivousFilter = USE_PREVIOUS_FILTER_DEFAULT;
    private Function<MessageType, MessageType> schemaConvertor = schema -> schema;
    ...
    public Builder withSchemaConvertor(Function<MessageType, MessageType> schemaConvertor) {
      this.schemaConvertor = schemaConvertor;
      return this;
    }
    ...
    public Builder copy(ParquetReadOptions options) {
      ...
      usePreviousFilter(options.usePreviousFilter);
      withSchemaConvertor(options.schemaConvertor);
    ...
    public ParquetReadOptions build() {
      return new ParquetReadOptions(
          ...
          codecFactory,
          allocator,
          maxAllocationSize, fileDecryptionProperties);
    }
  }
}
